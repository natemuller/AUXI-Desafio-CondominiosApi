...
namespace CondominiosApi.Tests.Integration;
...
public class AuthenticationIntegrationTests
{
    ...
    [Fact]
    public async Task GetCondominios_SemHeaderDeAutorizacao_Retorna401()
    {
        ...
        try
        {
            ...
            var resposta = await client.GetAsync("/api/condominios");
    ...
    [Fact]
    public async Task GetCondominioPorCodigo_SemHeaderDeAutorizacao_Retorna401()
    {
        var connectionStringOriginal = Environment.GetEnvironmentVariable(ConnectionStringEnvVar);
        var signingKeyOriginal = Environment.GetEnvironmentVariable(SigningKeyEnvVar);
        ...
        try
        {
            ...
            var resposta = await client.GetAsync("/api/condominios/1");
